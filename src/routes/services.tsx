...
const blocks = [
  {
    ...
    points: ["Independent advice", "Provider process explanation", "No plan sales", "Fee-based assistance"],
  },
  {
    ...
    points: ["Informational support", "Provider reference only", "Setup guidance", "No affiliation claims"],
  },
  {
    ...
    points: ["Provider navigation", "Billing explanations", "Network readiness", "Independent perspective"],
  },
  {
    ...
    points: ["Coverage tips", "Equipment awareness", "Troubleshooting guidance", "Non-technical explanations"],
  },
  {
    ...
    points: ["Provider neutral advice", "Troubleshooting paths", "Subscription clarity", "Informational only"],
  },
  {
    ...
    points: ["Router and device context", "Wi-Fi network advice", "No provider endorsement", "Independent support"],
  },
];
...
function ServicesPage() {
  return (
    <Layout>
      <SEO title="Services — letstream Hub" description="Independent service assistance for cable, internet, and streaming. Learn how we help with provider processes and troubleshooting." canonical="https://letstreamHub.com/services/" />
      <section className="py-24">
        <div className="container mx-auto px-6 lg:px-10">
          <Reveal>
            <p className="text-xs uppercase tracking-[0.3em] text-gold">Assistance</p>
            <h1 className="font-display text-5xl md:text-7xl mt-4 max-w-3xl text-balance">Independent service assistance for cable, internet, and streaming.</h1>
            <p className="mt-6 max-w-2xl text-muted-foreground text-lg leading-relaxed">
              We do not sell plans. We provide clarity, explain provider procedures, and help you understand the next steps for your service questions.
            </p>
            <p className="mt-4 text-sm text-muted-foreground max-w-2xl leading-relaxed">
              letstream Hub is an independent third-party service assistance provider. We are not affiliated with, authorized by, or endorsed by any provider.
            </p>
          </Reveal>
        </div>
      </section>
            ...
            <Reveal key={b.title}>
              <article className={`grid lg:grid-cols-12 gap-12 items-center ${i % 2 ? "lg:[direction:rtl]" : ""}`}>
                ...
                <div className="lg:col-span-6 [direction:ltr]">
                  ...
                  <a href="tel:(888) 478-6124" className="mt-8 inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-red text-primary-foreground shadow-glow-red hover:scale-105 transition-transform">
