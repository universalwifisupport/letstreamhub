...
function PrivacyPage() {
  return (
    <Layout>
      <SEO
        title="Privacy Policy — letstream Hub"
        description="letstream Hub privacy policy describing data collection, usage, and your rights."
        canonical="https://letstreamHub.com/privacy/"
      />
        ...
        <div className="container mx-auto px-6 lg:px-10 max-w-3xl">
          ...
          <div className="prose prose-invert mt-10 space-y-8 text-muted-foreground leading-relaxed">
            ...
            <Section title="2. Information We Collect">
              We collect information you provide directly when you request assistance, such as your
              name, email, phone, ZIP code, and support details. We may also collect usage data to
              help improve the website and advisory experience.
            </Section>
            <Section title="3. How We Use Your Information">
              We use data to respond to assistance requests, share relevant guidance, improve our
              content, and operate the website securely. We do not sell your personal information.
            </Section>
            <Section title="4. Information Sharing">
              We may share information with trusted service providers that help us operate the
              business, such as email and payment processors. We do not share provider passwords or
              other sensitive login credentials.
            </Section>
            <Section title="5. Data Security">
              We use reasonable administrative, technical, and physical safeguards to protect your
              information. Access is limited to authorized personnel who need the data to support
              our operations.
            </Section>
            ...
            <Section title="7. Cookies & Tracking">
              The site uses essential cookies to function and optional analytics cookies to improve
              the experience. You may manage cookie preferences through your browser.
            </Section>
