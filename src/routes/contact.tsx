...
function ContactPage() {
  ...
  return (
    <Layout>
      <SEO
        title="Contact — letstream Hub"
        description="Contact letstream Hub for independent, third-party service assistance with internet, cable, and streaming questions."
        canonical="https://letstreamHub.com/contact/"
      />
        ...
        <div className="container mx-auto px-6 lg:px-10">
          <Reveal>
            ...
            <h1 className="font-display text-5xl md:text-7xl mt-4 max-w-3xl text-balance">
              Need independent service assistance?
            </h1>
            <p className="mt-6 max-w-2xl text-muted-foreground text-lg leading-relaxed">
              We support you with guidance on internet, cable, and streaming provider processes.
              Email or message us to request help from an independent advisor.
            </p>
            <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
              Thank you for reaching out to letstream Hub, an independent service assistance
              platform. We are not affiliated with, authorized by, or endorsed by any provider.
            </p>
          </Reveal>
        </div>
      </section>
              ...
              {submitted ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-muted-foreground mt-3">
                    A letstream Hub advisor will reach out within one business day.
                  </p>
                </div>
              ) : (
                <form
                ...
                >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={5}
                      className="w-full bg-input/40 border border-border rounded-2xl px-5 py-4 outline-none focus:border-gold transition"
                    />
                  </div>
          ...
          <Reveal delay={150}>
            <div className="space-y-4">
              ...
              <InfoCard
                ...
                href="mailto:hello@letstreamHub.com"
              />
              <InfoCard
                icon={MapPin}
                label="Official Address"
                value="2120 Carrell Rd Apt 219, Fort Myers, FL 33901-8051, USA"
              />
            ...
            <div className="glass rounded-3xl overflow-hidden h-[420px] relative">
              ...
              <div className="absolute bottom-6 left-6 glass rounded-2xl px-5 py-3 max-w-[calc(100%-3rem)]">
                ...
                <div className="font-display text-sm md:text-base">
                  2120 Carrell Rd Apt 219, Fort Myers, FL 33901-8051, USA
                </div>
              </div>
            </div>
          </Reveal>
  ...
  return (
    <div>
      ...
      <input
        ...
        type={type}
        required={required}
        className="w-full bg-input/40 border border-border rounded-xl px-4 py-3 outline-none focus:border-gold transition"
      />
    </div>
  );
}
