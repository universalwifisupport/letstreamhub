        ...
        <div className="grid lg:grid-cols-12 gap-16 mb-20">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-muted-foreground leading-relaxed max-w-sm mb-8">
              letstream Hub is an independent third-party service assistance startup. We are not
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium leading-relaxed">
                    2120 Carrell Rd Apt 219,
                    <br />
                    Fort Myers, FL 33901-8051, USA
                  </div>
                </div>
              </div>
            </div>
...
function SocialIcon({ icon: Icon }: { icon: typeof Twitter }) {
  return (
    <a
      href="#"
      className="w-10 h-10 rounded-full bg-card border border-border/40 grid place-items-center hover:bg-primary hover:border-primary text-foreground hover:text-primary-foreground transition-all duration-300"
    >
